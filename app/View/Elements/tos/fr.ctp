    ...
    <div class="container" style="overflow-x: hidden">
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p class="small text-left font-italic text-center"><?= __d('tos', 'effective') ?></p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container" style="overflow-x: hidden">
      <div class="row">
        <div class="col-md-12">
          ...
          <p>
            <?= __d('tos', '3.intellectual_property.2-2', Configure::read('Site.name2')); ?>
          </p>
          ...
          <h4><?= __d('tos', '4.payment_and_pricing.title'); ?></h4>
          ...
          <p class="text-uppercase"><?= __d('tos', '9.limitation_of_liability.2', Configure::read('Site.name2')); ?></p>
          <p><?= __d('tos', '9.limitation_of_liability.3', Configure::read('Site.name2')); ?></p>
